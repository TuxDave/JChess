...
public abstract class Launcher extends JPanel implements ReadyListener {
    ...
    protected GPlayerCreator gPlayerCreator1;
    protected GPlayerCreator gPlayerCreator2;
    ...
    public Launcher() {
        ...
        AtomicReference<Dimension> d = new AtomicReference<>(new Dimension(WIDTH, HEIGHT));
        panel1.setOpaque(false);
        panel1.setMinimumSize(d.get());
        panel1.setMaximumSize(d.get());
        panel1.setPreferredSize(d.get());
        add(panel1);
